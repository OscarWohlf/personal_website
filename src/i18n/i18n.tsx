...
const en: Dict = {
  ...
  "home.p1": "Hello! My name is Oscar Johan Høeg Wohlfahrt. I'm a Norwegian student currently on my first semester of the MSc in Computational Science and Engineering at EPFL in Lausanne, Switzerland. I recently completed a BSc in General Engineering at DTU in Copenhagen. Earlier, I spent a semester at NYU's Courant Institute in New York and a year studying finance in Milan.",
  "home.p2": "My academic interests lie in the intersection of mathematics and computer science. I like learning ideas properly and then putting them into code. I care about applying methods to real problems, but also believe a solid theoretical foundation helps me understand what I'm doing. In my BSc thesis at DTU, I used survival analysis to estimate building lifetimes from Danish registry data. I'm curious about different application areas and currently interested in gaining experience in many domains.",
